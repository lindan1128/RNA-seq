...
```{r}
Test_Data <- read.csv(file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_test_data.csv", header=TRUE, sep=",",row.names=NULL) # row.names = 1
```
...
write.csv(data,"/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_test_data_v1.csv")
```

## input real data
```{r}
Test_Data <- read.csv(file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_test_data_v1.csv", header=TRUE, fill=T,sep=",",row.names=NULL) 
```
...
#write.csv(Test_DEGs,file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/Test_DEGs.csv")
```
