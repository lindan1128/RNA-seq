...
```{r}
MyData <- read.csv(file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_data.csv", header=TRUE, sep=",",row.names=NULL) # row.names = 1
```
...
write.csv(data,"/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_data_v1.csv")
```

## Input real data
```{r}
MyData <- read.csv(file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/ctc_vs_pt_data_v1.csv", header=TRUE, fill=T,sep=",",row.names=NULL) 
```
...
#write.csv(DEGs,file="/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/DEGs.csv")
```
...
```{r}
save(gsca, file = "/Users/lindan/Dropbox/PhD/Course/Genomics\ and\ Bioinformatics/Final\ Project/Galaxy.RData")
```
